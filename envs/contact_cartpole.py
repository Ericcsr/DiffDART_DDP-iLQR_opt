...
class ContactCartPoleEnv(DiffDartEnv):
    def __init__(self,FD=False):
        ...
        leftPlaneOffset.set_translation([-4.0, 0.5, 0])
        leftSpring.setTransformFromParentBodyNode(leftPlaneOffset)
        leftSpring.setSpringStiffness(0, 0.4)
